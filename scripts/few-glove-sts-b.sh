...
CUDA_VISIBLE_DEVICES=$node fairseq-train $TASK-bin$K/ \
    ...
    --freeze-encoder \
    --add-suffix --suffix-len $prefixlen --prompt-generation --generation-freeze --insert-position $insertposition --generation-layer 2 --generation-quaternions $gq --middle-prompt-insert-layer 1 --middle-prompt-mode layerb --phm-bottleneck-dim 16 --prompt-insert-mode 1 --glove $gl \
