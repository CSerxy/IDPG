...
parser.add_argument("-o", "--output_file", default="/fsx/zhuofeng/result/efl/mpqa.txt", help="the result file")
...
parser.add_argument("-d", "--data_file", default="data/mpqa-test.csv", help="the data")
...
roberta = RobertaModel.from_pretrained(
    ...
    data_name_or_path='mpqa-bin'+args.kn,
)
...
with open(args.output_file, 'a') as outf:
    outf.write('mpqa: ' + args.froms + '-' + args.to + '-' + args.number + '-' + args.klr + '| Accuracy: ' + str(float(ncorrect)/float(nsamples)) + '\n')
