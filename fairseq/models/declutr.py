...
@register_model('declutr')
class DeclutrModel(FairseqEncoderModel):
    """
...
@register_model_architecture('declutr', 'declutr')
...
@register_model_architecture('declutr', 'declutr_base')
def bert_base_architecture(args):
    base_architecture(args)


@register_model_architecture('declutr', 'declutr_large')
