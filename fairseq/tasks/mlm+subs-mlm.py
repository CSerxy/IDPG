...
@register_task('mlm+subs-mlm')
class MLM_SUBS_MLMTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--neighbor-path', default='bpe_after_dic.bpe', type=str,
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        src_dataset2, tgt_dataset2 = MaskSubsTokensDataset.apply_mask(
            dataset,
            self.source_dictionary,
            subs=self.subs,
            pad_idx=self.source_dictionary.pad(),
            mask_idx=self.mask_idx,
            seed=self.args.seed * 500 + 1,
            mask_prob=self.args.mask_prob,
            leave_unmasked_prob=self.args.leave_unmasked_prob,
