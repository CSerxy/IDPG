...
@register_task('del_eli')
class CL_Del_EliTask(FairseqTask):
    ...
    def load_dataset(self, split, epoch=3, combine=False, **kwargs):
        ...
        src_dataset1, src_dataset2 = DelEliDataset.apply_mask(
            dataset,
            self.args.seed,
            self.source_dictionary,
            ...
            NestedDictionaryDataset(
                {
                    ...
                    'net_input': {
                        ...
                        'src_lengths': NumelDataset(src_dataset1, reduce=False),
                    },
                   'argumentation': PadDataset(
                        src_dataset2,
                        pad_idx=self.source_dictionary.pad(),
                        left_pad=False,
                    ),
                    'nsentences': NumSamplesDataset(),
                    'ntokens': NumelDataset(src_dataset1, reduce=True),
                },
                sizes=[src_dataset1.sizes],
            ),
            sort_order=[
                shuffle,
                src_dataset1.sizes,
