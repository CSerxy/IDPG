...
class SBERTTask(FairseqTask):
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        src_tokens0 = maybe_shorten_dataset(
            input0,
            split,
        ...
        src_tokens1 = maybe_shorten_dataset(
            input1,
            split,
            self.args.shorten_data_split_list,
            self.args.shorten_method,
        ...
        dataset = {
            ...
            'net_input0': {
                ...
                'src_lengths': NumelDataset(src_tokens0, reduce=False),
            },
            'net_input1': {
                'src_tokens': RightPadDataset(
                    src_tokens1,
                ...
                'src_lengths': NumelDataset(src_tokens1, reduce=False),
            },
            'nsentences': NumSamplesDataset(),
            'ntokens': NumelDataset(src_tokens0, reduce=True),
        }
